...
| 5. Saved & Parameterised Analysis Library | Complete | A discoverable, parameterised library spanning saved SQL and existing Python analytical primitives. | [`72fbe0d`](https://github.com/TheAsarya/NDAT/commit/72fbe0d); see [Stage 5 detail](stage-5-analysis-library.md). | Saved SQL and Python remain first-class; no structured query DSL, UI, or run-history database is included. |
